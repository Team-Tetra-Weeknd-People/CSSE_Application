...
export default function ProcDeliveryNoteScreen({ route }) {
  ...
  return (
    ...
    {deliveryNote ? (<View style={styles.container}>
      <Text style={styles.heading}>Delivery Note Details</Text>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.value}>{deliveryNote.deliveryNote}</Text>
      </View>
      <View style={styles.detailsContainer}>
        <Text style={styles.label}>Item Description:</Text>
        <Text style={styles.value}>{deliveryNote.itemDescription}</Text>
      </View>
      <View style={styles.detailsContainer}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.value}>{deliveryNote.createdOn}</Text>
      </View>
      <View style={styles.detailsContainer}>
        <Text style={styles.label}>Updated On:</Text>
        <Text style={styles.value}>{deliveryNote.updatedOn}</Text>
      </View>
