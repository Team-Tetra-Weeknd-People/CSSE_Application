...
export default function SupplierDashboard() {
  ...
  const handleShowEditCatalogueModel = () => setShowEditCatalogue(true);
  const handleCloseEditItem = () => setShowEditItem(false);
  const handleShowEditItem = () => setShowEditItem(true);

  useEffect(() => {
    Catalogueservice.getCatalogueSupplier(localStorage.getItem("id")).then(
      (res) => {
  ...
  function handleShowEditCatalogue(record) {
    setCatalogue(record);
              ...
              <Container style={{ marginTop: "10px" }}>
                <Row>
                  <Col>
                    ...
                    <br />
                    <Button variant="primary" onClick={handleShowAddCatalogue}>
                      Add New Catalogue
                    </Button>
                  </Col>
                  <Col>
